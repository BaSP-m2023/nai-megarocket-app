...
class AdminPage {
  ...
  get btnCancelModalSubscription() {
    return $('#admin-button-close-success-modal');
  }
  get btnDeleteModal() {
    return $('#admin-modal');
  }
  ...
  get btnSelectSchedule() {
    return $('#admin-button-class-thursday-11');
  }
  get btnSubmit() {
  ...
  get inputClassPilates11() {
    return $('#admin-input-classes-64b7e6b656c431578839b16f');
  }
  get inputClassBoxing17() {
    return $('#admin-input-classes-64b764b0bfebad42e352a14d');
  }
  get inputMember() {
    return $('#admin-input-member');
  }
  get inputMemberAlberto() {
    return $('#admin-input-member-64b7d6368eeee423c17268bc');
  }
  get selectClassActivity() {
    return $('#admin-select-activity');
  }
  get selectClassActivityPilates() {
    return $('#admin-classes-select-activity-pilates');
  }
  get selectClassTrainer() {
    return $('#admin-select-trainer');
  }
  get selectClassTrainerNaza() {
    return $('#admin-classes-select-trainer-Nazarena');
  }
  get scrollImages() {
    return $(
      '#root > div.layout_center__DWPZJ > div.container_container__xTUOV > div > div:nth-child(2) > ul > li:nth-child(7) > img'
    );
  }
  get packOfImages() {
    return $(
      '#root > div.layout_center__DWPZJ > div.container_container__xTUOV > div > div:nth-child(2) > ul'
    );
  }
  async fillForm() {
